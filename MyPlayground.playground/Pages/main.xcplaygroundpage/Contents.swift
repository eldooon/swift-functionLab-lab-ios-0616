...
greetingPerson("Eldon")
greetingPerson("Henry")
greetingPerson("No One")
/*: question4
...
// write your code here
func randomFunction(){
    var randomThing = "Random Thing"
    print (randomThing)
    randomThing = "Another Random"
    print (randomThing)
}

randomFunction()
randomFunction() //function gets prints both assigned variable because it was print before and after the variable got changed
/*:
 [Solution](solution)
 */
